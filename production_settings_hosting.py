# Production Settings for Hosting
import os
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-$))$linnq%u372h2xc0_gpfp5k$aw(n(jyn!y1q4(#=+llqp&3')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'booking.context_processors.admin_stats',
            ],
        },
    },
]
...
DATABASES = {
    'default': dj_database_url.parse(
        ...
        'mysql://root:@localhost:3306/room_booking')
    )
}
