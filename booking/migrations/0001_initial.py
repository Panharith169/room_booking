# Generated by Django 4.2.7 on 2025-06-28 08:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('faculty', 'Faculty'), ('staff', 'Staff'), ('admin', 'Administrator')], default='student', help_text='Type of user', max_length=20)),
                ('student_id', models.CharField(blank=True, help_text='Student ID number (for students)', max_length=20, null=True, unique=True)),
                ('employee_id', models.CharField(blank=True, help_text='Employee ID number (for faculty/staff)', max_length=20, null=True, unique=True)),
                ...
                ('is_approved', models.BooleanField(default=False, help_text='Whether the user account is approved for booking')),
                ('max_concurrent_bookings', models.PositiveIntegerField(default=2, help_text='Maximum number of concurrent active bookings allowed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_daily_bookings', models.PositiveIntegerField(default=2, help_text='Maximum bookings per user per day', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
                ('max_weekly_bookings', models.PositiveIntegerField(default=5, help_text='Maximum bookings per user per week', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(50)])),
                ('advance_booking_days', models.PositiveIntegerField(default=14, help_text='How many days in advance users can book', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(365)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Whether the room is active and bookable')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['room_type'], name='rooms_room_ty_7b8350_idx'), models.Index(fields=['availability_status'], name='rooms_availab_94a3ec_idx'), models.Index(fields=['is_active'], name='rooms_is_acti_b7cb02_idx')],
            },
        ),
        migrations.CreateModel(
            name='Announcement',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['is_active', 'show_until'], name='announcemen_is_acti_13e55a_idx'),
        ),
        migrations.AddIndex(
            model_name='announcement',
            index=models.Index(fields=['announcement_type'], name='announcemen_announc_b7733d_idx'),
        ),
        migrations.AddIndex(
            model_name='announcement',
            index=models.Index(fields=['priority'], name='announcemen_priorit_370592_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['user_type'], name='custom_user_user_ty_2d25b4_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['is_approved'], name='custom_user_is_appr_d0ea36_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
            index=models.Index(fields=['student_id'], name='custom_user_student_46a355_idx'),
        ),
        migrations.AddIndex(
            model_name='customuser',
